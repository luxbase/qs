export default {
  ...
  pricing: {
    ...
    cta: 'Melhorar meu anúncio →',
      ...
      },
      {
        ...
        features: [
          ...
          'Reescrevemos a descrição',
          'Recebe o ZIP em 24 horas',
          'Entrega prioritária em 12 horas',
          'Grupo de WhatsApp dedicado',
          'Exports para Stories e Reels',
        ],
        cta: 'Começar →',
      ...
      },
      {
        ...
        features: [
          ...
          'Relatório mensal de propriedades',
        ],
        cta: 'Contatar →',
    ...
    paymentNote: 'Pague em guarani ou transferência · Todos os planos incluem fotos ilimitadas por propriedade + texto otimizado.',
    coldStart: {
